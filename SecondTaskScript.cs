...
public class SecondTaskScript : MonoBehaviour
{
    ...
    private bool scoreOne, scoreTwo, scoreThree, scoreFourth;   // Did the player answer correctly
    ...
    // Reads the value from the Dropdown UI element
    public void AnswerFourth(int value)
    {
        // The correctness of the player's answer is checked
        if (value == 1)
            scoreFourth = true;
    ...
    public void ButtonCheckingAnswer()
    {
        ...
        if (scoreOne && scoreTwo && scoreThree && scoreFourth)
    ...
    private void GetInformationOfGame()
    {
        ...
        taskText.text = AllTextScript.questionText[1];
    }
